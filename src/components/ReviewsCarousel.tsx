            ...
            <CarouselContent className="-ml-4">
              {reviews.map((review, index) => (
                <CarouselItem key={index} className="pl-4 md:basis-1/2 lg:basis-1/3">
                  <Card 
                    className="h-full shadow-cozy hover:shadow-warm transition-all duration-300 transform hover:scale-105 cursor-pointer relative overflow-hidden"
                  ...
                  >
                    <CardContent className="p-6 h-full flex flex-col">
                      ...
                      {/* Food Item Hover */}
                      {hoveredReview === index && (
                        <div className="absolute inset-0 bg-primary/95 backdrop-blur-sm flex items-center justify-center text-white animate-fade-in">
